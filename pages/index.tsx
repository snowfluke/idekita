...
export default function Home() {
  return (
    <>
      <Meta title={`iDekita ${emoji.lampu} Wadah Ide-ide Kreatif`} description="Cari, temukan, dan publikasikan ide-ide kreatif bersama dengan Idekiawan di seluruh Indonesia" />
      {/* <!-- Content --> */}
